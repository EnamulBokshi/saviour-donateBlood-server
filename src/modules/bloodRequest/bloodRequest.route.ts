...
bloodRequestRouter.post(
  "/",
  authCheck(UserRole.ADMIN, UserRole.SUPER_ADMIN, UserRole.USER, UserRole.DONOR),
  requestValidator(BloodRequestValidation.createBloodRequestValidationSchema),
  BloodRequestController.createBloodRequest,
);
bloodRequestRouter.patch(
  "/:id",
  authCheck(UserRole.ADMIN, UserRole.SUPER_ADMIN, UserRole.USER, UserRole.DONOR),
  requestValidator(BloodRequestValidation.updateBloodRequestValidationSchema),
  BloodRequestController.updateBloodRequest,
);
bloodRequestRouter.delete(
  "/:id",
  authCheck(UserRole.ADMIN, UserRole.SUPER_ADMIN, UserRole.USER, UserRole.DONOR),
